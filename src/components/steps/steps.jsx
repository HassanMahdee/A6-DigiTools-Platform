      ...
      <div className="flex flex-col items-center gap-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="card bg-base-100 shadow-xl flex flex-col items-center p-8 pt-4 pr-6 gap-4 hover:scale-105 transition-transform">
            <span className="self-end bg-primary rounded-full text-white w-6 h-6 flex items-center justify-center">1</span>
          ...
          <div className="card bg-base-100 shadow-xl flex flex-col items-center p-8 pt-4 pl-6 gap-4 hover:scale-105 transition-transform">
            <span className="self-end bg-primary rounded-full text-white w-6 h-6 flex items-center justify-center">2</span>
            <div className="bg-primary/10 rounded-full p-4">
              <img src={packageIcon} alt="product" className="w-12"/>
            </div>
          ...
          <div className="card bg-base-100 shadow-xl flex flex-col items-center p-8 pt-4 pl-6 gap-4 hover:scale-105 transition-transform">
            <span className="self-end bg-primary rounded-full text-white w-6 h-6 flex items-center justify-center">3</span>
            <div className="bg-primary/10 rounded-full p-4">
              <img src={rocketIcon} alt="creating" className="w-12"/>
            </div>
            <h3 className="card-title font-bold">Start Creating</h3>
            <p className="card-text font-light text-center">
              Start creating amazing content with our powerful tools. No
              learning curve - just start creating.
            </p>
          </div>
        </div>
      </div>
